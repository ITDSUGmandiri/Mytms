			...
			<div class="box">
				...
				<div class="box-body <?php if (!isset($open_form)){ echo "hide";} ?>" id="add_new">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<form action="<?php echo base_url('unit/save_edit') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							
						<?php foreach($list_unit->result() as $data){ ?>
								...
								<div class="col-md-8 <?php if (form_error('id_lok')) {echo "has-error";} ?>">
									...
									<select name="id_lok" id="id_lok" class="form-control" required>
										...
										<?php foreach ($data_list_area->result() as $val){ ?>
											<option value="<?php echo $val->id; ?>" <?php echo ($data->id_lok == $val->id?'selected':'') ?>><?php echo $val->nama_lokasi; ?> </option> 
										<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('nama_unit')) {echo "has-error";} ?>">
									<input type="text" name="nama_unit" id="nama_unit" class="form-control" value="<?php echo $data->nama_unit; ?>" placeholder="Nama Unit">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('blok')) {echo "has-error";} ?>">
									<input type="text" name="blok" id="blok" class="form-control" value="<?php echo $data->blok; ?>" placeholder="Blok">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('no_unit')) {echo "has-error";} ?>">
									<input type="text" name="no_unit" id="no_unit" class="form-control" value="<?php echo $data->no_unit; ?>" placeholder="No. Unit">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('lantai')) {echo "has-error";} ?>">
									<input type="number" min="0" maxlength="50" name="lantai" id="lantai" class="form-control" value="<?php echo $data->lantai; ?>" placeholder="Lantai">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('status_unit')) {echo "has-error";} ?>">
									...
									<input type="hidden" name="hidden_status_unit" id="hidden_status_unit" value="<?php echo $data->status_unit; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('penghuni_id')) {echo "has-error";} ?>">
									...
									<input type="hidden" name="hidden_penghuni_id" id="hidden_penghuni_id" value="<?php echo $data->penghuni_id; ?>">
									<input type="hidden" name="kode_penghuni" id="kode_penghuni" value="<?php echo $data->penghuni; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('dok')) {echo "has-error";} ?>">
									<input type="text" name="dok" id="dok" class="form-control" value="<?php echo $data->dok; ?>" placeholder="No. SPRD">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('tgl_sprd')) {echo "has-error";} ?>">
									...
									<div class="input-group date" id="datepicker_tgl_sprd">
                                    	...
                                    	<input type="text" class="form-control" id="tgl_sprd" name="tgl_sprd" value="<?php echo tgl_indo_ddmmyyyy($data->tgl_dok); ?>" placeholder="Tanggal SPRD" />
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('no_bast')) {echo "has-error";} ?>">
									<input type="text" name="no_bast" id="no_bast" class="form-control" value="<?php echo $data->no_bast; ?>" placeholder="No. BAST Masuk">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('tgl_bast')) {echo "has-error";} ?>">
									...
									<div class="input-group date" id="datepicker_tgl_bast">
                                    	...
                                    	<input type="text" class="form-control" id="tgl_bast" name="tgl_bast" value="<?php echo date('d/m/Y', strtotime($data->tgl_bast)) ?>" placeholder="Tanggal BAST Masuk" />
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('wilayah')) {echo "has-error";} ?>">
									...
									<input type="hidden" name="hidden_wilayah" id="hidden_wilayah" value="<?php echo $data->wilayah; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('kondisi')) {echo "has-error";} ?>">
									...
									<input type="hidden" name="hidden_kondisi" id="hidden_kondisi" value="<?php echo $data->kondisi; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('masuk')) {echo "has-error";} ?>">
									...
									<div class="input-group date" id="datepicker_tgl_masuk">
                                    	...
                                    	<input type="text" class="form-control" id="masuk" name="masuk" value="<?php echo tgl_indo_ddmmyyyy($data->masuk); ?>" placeholder="Tanggal Masuk" />
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('keluar')) {echo "has-error";} ?>">
									...
									<div class="input-group date" id="datepicker_tgl_keluar">
                                    	...
                                    	<input type="text" class="form-control" id="keluar" name="keluar" value="<?php echo tgl_indo_ddmmyyyy($data->keluar); ?>" placeholder="Tanggal Keluar" />
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('tgl_perbaikan')) {echo "has-error";} ?>">
									...
									<div class="input-group date" id="datepicker_tgl_perbaikan">
                                    	...
                                    	<input type="text" class="form-control" id="tgl_perbaikan" name="tgl_perbaikan" value="<?php echo tgl_indo_ddmmyyyy($data->tgl_perbaikan); ?>" placeholder="Tanggal Perbaikan" />
							...
							<div class="form-group">
									...
									<div class="col-md-8 <?php if (form_error('nominal_rab')) {echo "has-error";} ?>">
										<div class="input-group">
											...
											<input type="text" name="nominal_rab" id="nominal_rab" class="form-control" maxlength="12" min="0" value="<?php echo $this->fungsi->pecah($data->nominal_rab); ?>" placeholder="Nominal RAB">
										</div>
									</div>
								</div>
							...
							<div class="form-group">
								<label for="nominal_spk" class="control-label col-md-2">Nominal SPK</label>
									...
									<div class="col-md-8 <?php if (form_error('nominal_spk')) {echo "has-error";} ?>">
										<div class="input-group">
											<span class="input-group-addon">Rp</span>
											<input type="text" name="nominal_spk" id="nominal_spk" class="form-control" maxlength="12" min="0" value="<?php echo $this->fungsi->pecah($data->nominal_spk); ?>" placeholder="Nominal SPK">
										</div>
									</div>	
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('kontraktor')) {echo "has-error";} ?>">
									<input type="text" name="kontraktor" id="kontraktor" class="form-control" value="<?php echo $data->kontraktor; ?>" placeholder="Kontraktor">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_listrik')) {echo "has-error";} ?>">
									<input type="text" name="id_listrik" id="id_listrik" class="form-control" value="<?php echo $data->id_listrik; ?>" placeholder="ID Listrik">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_pam')) {echo "has-error";} ?>">
									<input type="text" name="id_pam" id="id_pam" class="form-control" value="<?php echo $data->id_pam; ?>" placeholder="ID PAM">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_telp')) {echo "has-error";} ?>">
									<input type="text" name="id_telp" id="id_telp" class="form-control" value="<?php echo $data->id_telp; ?>" placeholder="ID Telp">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_internet1')) {echo "has-error";} ?>">
									<input type="text" name="id_internet1" id="id_internet1" class="form-control" value="<?php echo $data->id_internet1; ?>" placeholder="ID Internet 1">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_internet2')) {echo "has-error";} ?>">
									<input type="text" name="id_internet2" id="id_internet2" class="form-control" value="<?php echo $data->id_internet2; ?>" placeholder="ID Internet 2">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_internet3')) {echo "has-error";} ?>">
									<input type="text" name="id_internet3" id="id_internet3" class="form-control" value="<?php echo $data->id_internet3; ?>" placeholder="ID Internet 3">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('id_internet4')) {echo "has-error";} ?>">
									<input type="text" name="id_internet4" id="id_internet4" class="form-control" value="<?php echo $data->id_internet4; ?>" placeholder="ID Internet 4">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('daya_listrik')) {echo "has-error";} ?>">
									<input type="text" name="daya_listrik" id="daya_listrik" class="form-control" value="<?php echo $data->daya_listrik; ?>" placeholder="Daya Listrik">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('hak_menempati')) {echo "has-error";} ?>">
									...
									<select name="hak_menempati" id="hak_menempati" class="form-control">
										...
										<option value="Ya" <?php echo ($data->hak_menempati == 'Ya'?'selected':'') ?>>Ya</option>
										<option value="Tidak" <?php echo ($data->hak_menempati == 'Tidak'?'selected':'') ?>>Tidak</option>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('klasifikasi_id')) {echo "has-error";} ?>">
									...
									<input type="hidden" name="hidden_klasifikasi_id" id="hidden_klasifikasi_id" value="<?php echo $data->klasifikasi_id; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<textarea name="keterangan" id="keterangan" class="form-control text_editor" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"><?php echo $data->keterangan; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<textarea name="alamat_lengkap" id="alamat_lengkap" class="form-control text_editor" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"><?php echo $data->alamat_lengkap; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('photo')) {echo "has-error";} ?>">
									...
									<?php if ($data->thumbnail != ''): ?>
										<img src="<?php echo base_url('assets/uploads/images/unit/').$data->thumbnail ?>" alt="Current Unit Photo">
									<?php endif ?>

									<input type="file" name="photo" id="photo" class="form-control" placeholder="Unit Photo">
								</div>
							</div>
