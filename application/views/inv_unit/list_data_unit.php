        ...
        <section class="content">
              ...
              <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <button onclick="location.href='<?php echo site_url(); ?>unit/add'" class="btn btn-primary" type="button">Tambah Unit</button>&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    var site_url = "<?php echo site_url() . 'unit/datatables_unit' ?>";
    var table;
    ...
    $(document).ready(function(){
      ...
      $('#id_lok, #id_unit, #id_status, #klasifikasi_id').change(function(){
        //table.draw();
        reload_table()
	   	});
  ...
  function edit(id, photo, thumbnail){
		window.location='<?php echo site_url(); ?>'+'unit/edit/'+id;
	}
