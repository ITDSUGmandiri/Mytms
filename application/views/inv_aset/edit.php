		...
		<div class="box">
        	...
        	<?php //echo $message; ?>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<form id="input_form" action="<?php echo base_url('aset/save_edit') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							
					<?php 
					foreach ($list_aset->result() as $val){
					?>
						...
						<h3>Basic Info</h3>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="nomor_aset" id="nomor_aset" class="form-control <?php if (form_error('nomor_aset')) { echo 'error'; } ?>" value="<?php echo $val->nomor_aset ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="nama" class="control-label col-md-2">* Nama Aset</label>
									<div class="col-md-4">
										<input type="text" name="nama" id="nama" class="form-control <?php if (form_error('nama')) { echo 'error'; } ?>" value="<?php echo $val->nama ?>">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="bagian" id="bagian" class="form-control <?php if (form_error('bagian')) { echo 'error'; } ?>" value="<?php echo $val->bagian ?>">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" name="merek" id="merek" class="form-control <?php if (form_error('merek')) { echo 'error'; } ?>" value="<?php echo $val->merek ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="model" class="control-label col-md-2">Model</label>
									<div class="col-md-8">
										<input type="text" name="model" id="model" class="form-control <?php if (form_error('model')) { echo 'error'; } ?>" value="<?php echo $val->model ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="bahan" class="control-label col-md-2">Bahan</label>
									<div class="col-md-8">
										<input type="text" name="bahan" id="bahan" class="form-control <?php if (form_error('bahan')) { echo 'error'; } ?>" value="<?php echo $val->bahan ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="kategori" class="control-label col-md-2">Jenis Aset</label>
									<div class="col-md-8">
										<input type="text" name="kategori" id="kategori" class="form-control <?php if (form_error('kategori')) { echo 'error'; } ?>" value="<?php echo $val->kategori ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="serial_number" class="control-label col-md-2">Serial Number</label>
									<div class="col-md-8">
										<input type="text" name="serial_number" id="serial_number" class="form-control <?php if (form_error('serial_number')) { echo 'error'; } ?>" value="<?php echo $val->serial_number ?>">
									</div>
								</div>
												...
												foreach ($cat_list->result() as $cls2):
													...
													<div class="radio">
														<label for="category2_<?php echo $cls2->id; ?>">
															<input type="radio" name="category2" id="category2_<?php echo $cls2->id; ?>" value="<?php echo $cls2->id; ?>" <?php if ($val->category_id == $cls2->id) : echo "checked"; endif; ?>>
															<?php echo $cls2->name ?>
														</label>
													</div>
												<?php
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="hidden" name="curr_status_aset" id="curr_status_aset" value="<?php $val->status_aset ?>">
										<div class="row">
												...
												foreach ($stat_list->result() as $sls2):
													...
													<div class="radio">
														<label for="status2_<?php echo $sls2->id; ?>">
															<input type="radio" name="status2" id="status2_<?php echo $sls2->id; ?>" value="<?php echo $sls2->id; ?>" <?php if ($val->status_aset == $sls2->id) : echo "checked"; endif; ?>>
															<?php echo $sls2->name ?>
														</label>
													</div>
												<?php
									...
									<div class="col-md-4">
										<select name="location" id="location" class="form-control select2 required" style="width:100%">
											<?php foreach ($loc_list->result() as $lls) {
												echo "<option value='" . $lls->id . "' " . ($lls->id == $val->id_area?'selected':'') . '>' . $lls->nama_lokasi . '</option>';
											} ?>
										</select>
										<input type="hidden" name="hidden_location" id="hidden_location" value="<?php echo $val->id_area ?>">
										<input type="hidden" name="curr_area_id" id="curr_area_id" value="<?php $val->id_area ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<input type="hidden" name="hidden_id_unit" id="hidden_id_unit" value="<?php echo $val->id_unit ?>">
										<input type="hidden" name="curr_unit_id" id="curr_unit_id" value="<?php $val->id_unit ?>">
									</div>
								</div>
							...
							<fieldset>
										...
										<div id="color_container">
											<select name="color" id="color" class="form-control select2 required" style="width:100%">
												<?php foreach ($col_list->result() as $crl) {
													echo "<option value='" . $crl->name . "' " . ($crl->name == $val->color?'selected':'') . '>' . $crl->name . '</option>';
												} ?>
											</select>
										</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="length" id="length" class="form-control" maxlength="12" min="0" value="<?php echo $val->length ?>">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="width" id="width" class="form-control" maxlength="12" min="0" value="<?php echo $val->width ?>">
											<span class="input-group-addon">Cm</span>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="height" id="height" class="form-control" maxlength="12" min="0" value="<?php echo $val->height ?>">
											<span class="input-group-addon">Cm</span>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="weight" id="weight" class="form-control" maxlength="12" min="0" value="<?php echo $val->weight ?>">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="number" name="kondisi" id="kondisi" class="form-control" maxlength="12" min="0" value="<?php echo $val->kondisi ?>">
							...
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											...
											<input type="text" name="harga_beli" id="harga_beli" class="form-control" value="<?php echo $this->fungsi->pecah($val->harga_beli) ?>">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
											<input type="text" name="tgl_beli" id="datepicker_tgl_beli" class="form-control" value="<?php echo tgl_indo_ddmmyyyy($val->tgl_beli) ?>">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea name="deskripsi" id="deskripsi" class="form-control text_editor" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"><?php echo $val->deskripsi ?></textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<?php if ($val->thumbnail != ''): ?>
										<img src="<?php echo base_url('assets/uploads/images/inventory/').$val->thumbnail ?>" alt="Current Unit Photo">
									<?php endif ?>

										<input type="file" name="photo" id="photo" class="form-control">
										<input type="hidden" name="curr_thumbnail" id="curr_thumbnail" value="<?php echo $val->thumbnail ?>" class="form-control">
										<input type="hidden" name="curr_photo" id="curr_photo" value="<?php echo $val->photo ?>" class="form-control">
