					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<form action="<?php echo base_url('ticket/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<textarea name="pelapor" id="pelapor" class="form-control" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"><?php echo set_value('pelapor'); ?></textarea>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<textarea name="job_detail" id="job_detail" class="form-control" rows="4" style="resize:vertical; min-height:100px; max-height:200px;"><?php echo set_value('job_detail'); ?></textarea>
