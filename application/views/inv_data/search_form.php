					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<table class="table table-striped table-bordered table-hover">
							...
							<?php if (count($results->result())>0): ?>
								...
								<tr>
									<td><?php echo $result->nomor_aset; ?></td>
									<td><?php echo $result->nama. ', ' . $result->merek. " " .$result->model; ?></td>
									...
									<td><?php if ($result->thumbnail!="") :?><a href="<?php echo base_url('assets/uploads/images/inventory/').$result->photo ?>" data-fancybox data-caption="<?php echo $result->brand . " " . $result->model ?>">
										<img src="<?php echo base_url('assets/uploads/images/inventory/').$result->thumbnail ?>" alt="<?php echo $result->merek . " " . $result->model ?>"></a><?php endif ?></td>
									<td width="15%">
										<form action="<?php echo base_url('inventory/delete/'.$result->nomor_aset) ?>" method="post" autocomplete="off">
											<div class="btn-group-vertical">
												<a class="btn btn-sm btn-default" href="<?php echo base_url('inventory/detail/'.$result->nomor_aset) ?>" role="button"><i class="fa fa-eye"></i> Detail</a>
												<a class="btn btn-sm btn-primary" href="<?php echo base_url('inventory/edit/'.$result->nomor_aset) ?>" role="button"><i class="fa fa-pencil"></i> Edit</a>
