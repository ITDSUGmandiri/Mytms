	...
	public function users($groups = NULL)
	{
		...
		else
		{
			...
			$this->db->select(array(
			    ...
			    $this->tables['lokasi_kerja'].'.nama_lokasi',
			    $this->tables['user_type'].'.type',
				$this->tables['users_photo'].'.photo',
				$this->tables['users_photo'].'.thumbnail'
			));
		}

		// add join lokasi_kerja

		$this->db->join(
		    $this->tables['lokasi_kerja'],
		    $this->tables['lokasi_kerja'].'.id = '.$this->tables['users'].'.lok_id',
		    'left'
		);
		...
		$this->db->join(
		    $this->tables['user_type'],
		    $this->tables['user_type'].'.ut_id = '.$this->tables['users'].'.user_type_id',
		    'left'
		);
		...
		$this->db->join(
		    $this->tables['users_photo'],
		    $this->tables['users_photo'].'.username = '.$this->tables['users'].'.username',
		    'left'
		);
