...
$config['tables']['lokasi_kerja']    = 'lokasi_kerja';
$config['tables']['user_type']		 = 'user_type';
$config['tables']['users_photo']	 = 'users_photo';
...
$config['join']['lokasi_kerja'] = 'id';
$config['join']['user_type'] = 'ut_id';
$config['join']['users_photo'] = 'username';
 ...
 */
$config['site_title']                 = "https://itbs.slmugmandiri.co.id/mydashboard";       // Site Title, example.com
